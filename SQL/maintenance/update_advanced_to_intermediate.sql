...
-- =====================================================
-- 1. 更新 student_course_progress 表
-- =====================================================

PRINT N'1. 更新 student_course_progress 表的 ability_level...';
...
PRINT N'已更新 student_course_progress 表 ' + CAST(@updated_count AS NVARCHAR(10)) + N' 筆記錄';

GO

-- =====================================================
-- 2. 更新 student_class_type_abilities 表
-- =====================================================

PRINT N'2. 更新 student_class_type_abilities 表的 ability_level...';
...
PRINT N'已更新 student_class_type_abilities 表 ' + CAST(@updated_count AS NVARCHAR(10)) + N' 筆記錄';

GO

-- =====================================================
-- 3. 更新 students 表的 level 欄位
-- =====================================================

PRINT N'3. 更新 students 表的 level 欄位...';
...
SET @updated_count = @@ROWCOUNT;
PRINT N'已更新 students 表 ' + CAST(@updated_count AS NVARCHAR(10)) + N' 筆記錄';

GO

-- =====================================================
-- 4. 更新 teacher_courses 表的 max_level 欄位
-- =====================================================

PRINT N'4. 更新 teacher_courses 表的 max_level 欄位...';
...
SET @updated_count = @@ROWCOUNT;
PRINT N'已更新 teacher_courses 表 ' + CAST(@updated_count AS NVARCHAR(10)) + N' 筆記錄';
...
-- 更新 student_course_progress 表的檢查約束
...
BEGIN
    ...
    PRINT N'已更新 student_course_progress 表的檢查約束';
END

-- 更新 student_class_type_abilities 表的檢查約束
...
BEGIN
    ...
    PRINT N'已更新 student_class_type_abilities 表的檢查約束';
END

-- 更新 students 表的檢查約束
IF EXISTS (SELECT * FROM sys.check_constraints WHERE name = 'CHK_students_level')
BEGIN
    ALTER TABLE students 
    DROP CONSTRAINT CHK_students_level;
    
    ALTER TABLE students 
    ADD CONSTRAINT CHK_students_level 
    CHECK (level IN (N'新手', N'入門', N'中階', N'高階', N'大師'));
    
    PRINT N'已更新 students 表的檢查約束';
END

-- 更新 teacher_courses 表的檢查約束
...
BEGIN
    ...
    PRINT N'已更新 teacher_courses 表的檢查約束';
END
