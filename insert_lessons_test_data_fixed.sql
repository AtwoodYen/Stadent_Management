...
(5, DATEADD(day, 13 - DATEPART(weekday, @today), @today), '15:00:00', 60, 'online', 'normal', 
 N'測試資料 - MySQL資料庫優化線上課程'),

(6, DATEADD(day, 13 - DATEPART(weekday, @today), @today), '18:00:00', 90, 'physical', 'normal', 
 N'測試資料 - 2D遊戲開發Cocos2d - B203教室'),

-- 下週日
(4, DATEADD(day, 14 - DATEPART(weekday, @today), @today), '11:00:00', 90, 'online', 'normal', 
 N'測試資料 - After Effects動態圖形設計線上課程'),

(7, DATEADD(day, 14 - DATEPART(weekday, @today), @today), '16:00:00', 60, 'physical', 'normal', 
